...
if authentication_status:
    ...
    # Create bar chart showing total time spent riding each week
    if not df_athlete_data_zones_restrict.empty and 'POWER_ZONE_SECONDS' in df_athlete_data_zones_restrict.columns:
        ...
        current_week_start = pd.Timestamp('2025-10-13').normalize()  # Monday Oct 13, 2025
